...
export default function GroupCardSmall({
  ...
  return (
    <div className="w-[160px] p-1 md:p-2 flex flex-col rounded-md items-center h-[200px] border-2 bg-purple-50 border-purple-300 hover:border-purple-400 hover:bg-purple-50">
